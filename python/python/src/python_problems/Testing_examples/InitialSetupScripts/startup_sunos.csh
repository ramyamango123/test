...
setenv CC  /afs/cern.ch/project/sun/solaris/opt/SUNWspro7/bin/CC
...
# To set the path for LCG stuff (CppUnit, Oval, ...)
 setenv PATH /afs/cern.ch/sw/lcg/external/packages/0.0.1/sunos58/bin:$PATH
 echo "--------------------------------------------------------------------"
 echo "  LCG stuff                                                         "
 echo "--------------------------------------------------------------------"
...
if ($?LD_LIBRARY_PATH) then
 setenv LD_LIBRARY_PATH '/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/sunos58/lib':$LD_LIBRARY_PATH
else
 setenv LD_LIBRARY_PATH '/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/sunos58/lib' 
endif
if ( "${?CPPUNIT_LDFLAGS}" != " " ) then
  echo "--------------------------------------------------------------------"
  echo " CPPUNIT settings                                                   "
  setenv CPPUNIT_LDFLAGS '-L/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/sunos58/lib -lcppunit -ldl'
  setenv CPPUNIT_INCLUDES   '/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/sunos58/include' 
  setenv ACLOCAL  /afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/sunos58/share/aclocal/
