#!/bin/bash #-----------------------------------------------------------------
# $Id:$ # Setup of the LCG-SPI software testing examples
...
# To set the path for LCG stuff (CppUnit, Oval, ...)
 export PATH=/afs/cern.ch/sw/lcg/external/packages/0.0.1/rh73_gcc32/bin:$PATH
 echo "--------------------------------------------------------------------"
 echo "  LCG stuff                                                         "
 echo "--------------------------------------------------------------------"
...
#Checks if LD_LIBRARY_PATH has something 
 export LD_LIBRARY_PATH=/afs/cern.ch/sw/lcg/external/packages/0.0.1/rh73_gcc32/lib:$LD_LIBRARY_PATH
  echo "--------------------------------------------------------------------"
  echo " CPPUNIT settings                                                   "
  export CPPUNIT_LDFLAGS='-L/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/rh73_gcc32/lib -lcppunit -ldl'
  export CPPUNIT_INCLUDES=/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/rh73_gcc32/include
  export ACLOCAL=/afs/cern.ch/sw/lcg/external/CppUnit/1.8.0/rh73_gcc32/share/aclocal/
