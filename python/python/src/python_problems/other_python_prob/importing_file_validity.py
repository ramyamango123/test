# If we impor class then all methods are automatically imported. Howvever while using it in methods u have to create an instance of tha class and then required method
