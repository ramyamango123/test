...
class ChatSetting(TestSuiteBase):
    ...
    def test_validParentIdChildIdUnMutedyParent(self):
    ...
    def test_validParentIdChildIdMutedByCS(self):
        ...
        self.toolBox.scriptOutput("chatSetting - Valid ParentId ChildId", {"Child Id": childId, "childUsername":childUsername})
    ...
    def test_validParentIdChildIdUnmutedByCS(self):
        ...
        self.muteStatusChangeThroughGman(childUsername, "UNMUTED")
