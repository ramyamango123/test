# If we import class then all methods are automatically imported. Howvever while using it in methods 
#u have to create an instance of that class and then required method
from file_validity import File_test
# We cannot directly import class method. Only if that method is outside class u can do this. So first import
# statement is valid.
